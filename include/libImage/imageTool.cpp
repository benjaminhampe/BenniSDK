...
//=========================================================================
{
	dbPRINT("ImageTool::getHeight()\n");

	if (!src)
	{
		dbERROR("invalid image pointer\n");
		return 0;
	}
...
//=========================================================================
{
	dbPRINT("ImageTool::createImage( %d, %d, %d)\n", size.Width, size.Height, format );
...
//=========================================================================
{
	dbPRINT("ImageTool::createCircleBrush( %f )\n", radius );
...
//=========================================================================
{
	dbPRINT("ImageTool::createImageFromTexture()\n");

    if (!driver)
    {
		dbERROR("no valid pointer to video-driver\n");
        return 0;
    }

    if (!src)
    {
		dbERROR("no valid texture pointer\n");
        return 0;
    }
...
//=========================================================================
{
	dbPRINT("ImageTool::createTexture()\n");
	...
	if (!src)
    {
		dbERROR("no valid image pointer\n");
        return 0;
    }
...
//=========================================================================
{
	...
	if (!src)
	{
		dbERROR("Invalid pointer to IImage\n");
		return false;
	}
...
//=========================================================================
{
	...
	if (!atlas.Image)
	{
		dbERROR("could not create atlas-image ( %d, %d )\n", w, h );
		return false;
	}
	...
	dbPRINT( "created atlas-image ( %d, %d )\n", w, h );
	return true;
}
...
//=========================================================================
{
	dbPRINT("ImageTool::setAtlasTile( %d, %d )\n", index_x, index_y );
	if (!atlas.Image)
	{
...
//=========================================================================
{
	dbPRINT("ImageTool::updateAtlasImage()\n" );
...
{
	dbPRINT("ImageTool::getUniqueColorCount()\n");
...
{
	dbPRINT("ImageTool::getUniqueColorArray()\n");
